...
function install_ritual_node() {
    ...
    sed -i "s|\"sync_period\": [0-9]*|\"sync_period\": $SYNC_PERIOD|" deploy/config.json || echo "\"sync_period\": $SYNC_PERIOD," >> deploy/config.json
    ...
    sed -i "s|\"sync_period\": [0-9]*|\"sync_period\": $SYNC_PERIOD|" projects/hello-world/container/config.json || echo "\"sync_period\": $SYNC_PERIOD," >> projects/hello-world/container/config.json
